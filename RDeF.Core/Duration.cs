...
namespace System
{
    ...
    public struct Duration
    {
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "years", Justification = "This code is not supposed to be a subject for static code analysis.")]
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "months", Justification = "This code is not supposed to be a subject for static code analysis.")]
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "days", Justification = "This code is not supposed to be a subject for static code analysis.")]
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "hours", Justification = "This code is not supposed to be a subject for static code analysis.")]
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "minutes", Justification = "This code is not supposed to be a subject for static code analysis.")]
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "seconds", Justification = "This code is not supposed to be a subject for static code analysis.")]
        ...
        {
            return (!Object.Equals(obj, null)) && (obj is Duration) && (this == (Duration)obj);
        }

        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "This code is not supposed to be a subject for static code analysis.")]
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "nanoseconds", Justification = "This code is not supposed to be a subject for static code analysis.")]
