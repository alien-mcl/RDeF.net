...
{
    [TestFixture]
    public class and_searching_for_property_mapping : DefaultMappingRepositoryTest
    {
        ...
        {
            MappingRepository.Invoking(instance => instance.FindPropertyMappingFor(null)).ShouldThrow<ArgumentNullException>();
        }
