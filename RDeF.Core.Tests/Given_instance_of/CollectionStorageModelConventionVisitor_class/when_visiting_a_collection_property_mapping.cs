...
{
    [TestFixture]
    public class when_visiting_a_collection_property_mapping : CollectionStorageModelConventionVisitorTest
    {
        ...
        {
            Provider.VerifySet(instance => instance.StoreAs = CollectionStorageModel.Simple, Times.Once);
        }
