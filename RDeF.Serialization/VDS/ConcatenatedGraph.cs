...
namespace RDef.RDF
{
    internal class ConcatenatedGraph : VDS.RDF.IGraph
    {
        private readonly IEnumerable<IGraph> _graphs;

        internal ConcatenatedGraph(IEnumerable<IGraph> graphs)
        {
            _graphs = graphs;
        ...
        public bool IsEmpty
        {
            get { return !_graphs.SelectMany(_ => _.Statements).Any(); }
        }
        ...
        {
            get { return new RDeF.RDF.TripleCollection(_graphs.SelectMany(_ => _.Statements)); }
        }
